    ...
    <div class="row">
        ...
        <div class="col-md-6 grid-margin stretch-card">
            ...
            <div class="card-body">
                ...
                @endif
                <form class="forms-sample" action="{{ route('admin.update-password') }}" method="post" enctype="multipart/form-data"> @csrf
                <div class="form-group">
                    <label>Admin Username/Email</label>
                    <input class="form-control" value="{{ $admindata['email'] }}" readonly>
                </div>
                <div class="form-group">
                    <label>Admin Type</label>
                    <input  class="form-control" value="{{ $admindata['type'] }}" readonly>
                </div>
                <div class="form-group">
